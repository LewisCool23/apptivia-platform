...
export const SUPPORTED_INTEGRATIONS: IntegrationTemplate[] = [
  ...
  { integration_type: 'microsoft_outlook', display_name: 'Microsoft Outlook', description: 'Calendar — meetings, scheduling', icon: 'MS', color: 'bg-apptivia-carbon-700' },
  { integration_type: 'google_calendar', display_name: 'Google (Calendar + Gmail)', description: 'Calendar meetings + send emails via Gmail', icon: 'GC', color: 'bg-apptivia-carbon-700' },
