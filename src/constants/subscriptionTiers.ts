...
export const TIER_LIMITS: Record<string, TierLimits> = {
  ...
  Pro: {
    ...
    integrations: ['apollo', 'csv', 'salesforce', 'hubspot', 'outreach', 'gong', 'salesloft', 'marketo', 'google_calendar', 'microsoft_calendar', 'sendoso', 'csv_upload'],
    support: 'priority',
    pricePerSeat: 49,
  },
  Enterprise: {
    ...
    integrations: ['apollo', 'csv', 'salesforce', 'hubspot', 'outreach', 'gong', 'salesloft', 'marketo', 'google_calendar', 'microsoft_calendar', 'sendoso', 'csv_upload', 'custom'],
    support: 'dedicated',
    pricePerSeat: null,
  },
};
