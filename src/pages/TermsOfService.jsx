  ...
  return (
    <div className="min-h-screen bg-apptivia-paper">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold text-apptivia-ink mb-2">Terms of Service</h1>
        <p className="text-sm text-apptivia-carbon-500 mb-10">Last updated: April 10, 2026</p>

        <div className="prose prose-gray max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">2. Description of Service</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">3. Account Registration and Organization</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">4. Subscription and Billing</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">5. Acceptable Use</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">You agree not to:</p>
            <ul className="list-disc pl-6 text-apptivia-carbon-700 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">6. Data Ownership and Intellectual Property</h2>

            <h3 className="text-lg font-medium text-apptivia-ink mb-2">6.1 Your Data</h3>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">
            ...
            <h3 className="text-lg font-medium text-apptivia-ink mb-2">6.2 Our Service</h3>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">
            ...
            <h3 className="text-lg font-medium text-apptivia-ink mb-2">6.3 AI-Generated Content</h3>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">7. Third-Party Integrations</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">8. Service Availability and Support</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
              We strive to maintain high availability of the Service but do not guarantee uninterrupted access. The Service may be temporarily unavailable due to maintenance, updates, or circumstances beyond our control. We will make reasonable efforts to provide advance notice of scheduled maintenance. Support is available via email at <a href="mailto:support@apptivia.app" className="text-apptivia-coral hover:underline">support@apptivia.app</a>.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">9. Limitation of Liability</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">10. Indemnification</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">11. Termination</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">12. Modifications to Terms</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">13. Governing Law</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">14. Contact</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
              Questions about these Terms should be directed to:<br />
              <a href="mailto:legal@apptivia.app" className="text-apptivia-coral hover:underline">legal@apptivia.app</a>
            </p>
          </section>
        </div>
      </main>
