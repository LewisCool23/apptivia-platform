  ...
  return (
    <div className="min-h-screen bg-apptivia-paper">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold text-apptivia-ink mb-2">Privacy Policy</h1>
        <p className="text-sm text-apptivia-carbon-500 mb-10">Last updated: April 10, 2026</p>

        <div className="prose prose-gray max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">1. Introduction</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">2. Information We Collect</h2>

            <h3 className="text-lg font-medium text-apptivia-ink mb-2">2.1 Account Information</h3>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">
            ...
            <h3 className="text-lg font-medium text-apptivia-ink mb-2">2.2 Sales Performance Data</h3>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">
            ...
            <h3 className="text-lg font-medium text-apptivia-ink mb-2">2.3 AI Interaction Data</h3>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">
            ...
            <h3 className="text-lg font-medium text-apptivia-ink mb-2">2.4 Usage and Technical Data</h3>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">3. How We Use Your Information</h2>
            <ul className="list-disc pl-6 text-apptivia-carbon-700 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">4. Data Sharing and Disclosure</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">5. Data Retention</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">6. Data Security</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
              We implement industry-standard security measures to protect your data. See our <Link to="/security" className="text-apptivia-coral hover:underline">Security page</Link> for detailed information about our security practices, including encryption, access controls, and infrastructure security.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">7. Your Rights</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed mb-3">Depending on your jurisdiction, you may have the following rights:</p>
            <ul className="list-disc pl-6 text-apptivia-carbon-700 space-y-2">
            ...
            <p className="text-apptivia-carbon-700 leading-relaxed mt-3">
              To exercise any of these rights, contact us at <a href="mailto:privacy@apptivia.app" className="text-apptivia-coral hover:underline">privacy@apptivia.app</a>.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">8. Multi-Tenant Data Isolation</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">9. Cookies and Tracking</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">10. Children's Privacy</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">11. Changes to This Policy</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-apptivia-ink mb-3">12. Contact Us</h2>
            <p className="text-apptivia-carbon-700 leading-relaxed">
              If you have questions about this Privacy Policy or our data practices, contact us at:<br />
              <a href="mailto:privacy@apptivia.app" className="text-apptivia-coral hover:underline">privacy@apptivia.app</a>
            </p>
          </section>
        </div>
      </main>
