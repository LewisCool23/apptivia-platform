...
export const idpStatusConfig = {
  draft:       { label: 'Draft',       color: 'bg-apptivia-carbon-100 text-gray-700',     icon: Clock,         borderColor: 'border-l-gray-400' },
  active:      { label: 'Active',      color: 'bg-apptivia-coral-tone-50 text-blue-700',     icon: Play,          borderColor: 'border-l-blue-500' },
  ...
  cancelled:   { label: 'Cancelled',   color: 'bg-apptivia-carbon-100 text-slate-500',   icon: XCircle,       borderColor: 'border-l-slate-400' },
};
