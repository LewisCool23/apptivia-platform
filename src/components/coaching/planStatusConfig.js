...
export const statusConfig = {
  ...
  active:      { label: 'Active',      color: 'bg-blue-100 text-blue-700',     icon: Clock,         borderColor: 'border-l-blue-500' },
  ...
  cancelled:   { label: 'Cancelled',  color: 'bg-gray-100 text-gray-500',    icon: Clock,         borderColor: 'border-l-gray-300' },
};
